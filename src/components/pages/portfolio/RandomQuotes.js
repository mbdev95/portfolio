...
const RandomQuotes = () => {
    return (
        <div className='portfolio--project'>
            ...
            <a href='https://github.com/mbdev95/OpenClassrooms-Project-5-Orwellian-Quotation-Generator/blob/master/README.md' target='_blank'><button type='button'>Application Explanation</button></a>
            <a href='https://mbdev95.github.io/OpenClassrooms-Project-5-Orwellian-Quotation-Generator/' target='_blank'><button type='button'>Application Live</button></a>
            <hr/>
        </div>
    );
}
