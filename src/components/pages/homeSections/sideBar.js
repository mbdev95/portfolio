...
const SideBar = () => {
  ...
  const homeProfileHeight = () => {
    ...
    const homeHeader = document
      .getElementsByClassName("home--header")[0]
      .getBoundingClientRect();
    const homeProfile = document.getElementsByClassName("home--profile")[0];
    const homeProfileHeight = home.height - homeHeader.height;
    const emptySpace = document.getElementsByClassName(
      "home--profile--empty"
    )[0];
    emptySpace.style.display = "block";
    if (
      home.bottom > homeProfile.getBoundingClientRect().bottom ||
      emptySpace.getBoundingClientRect().height > 0
    ) {
      homeProfile.style.setProperty(
        "--home-profile-height",
        homeProfileHeight + "px"
      );
      emptySpace.style.display = "none";
      homeProfile.style.setProperty(
        "--justify-content-home-profile",
        "space-evenly"
      );
    } else {
      homeProfile.style.setProperty(
  ...
  return (
    <>
      ...
      <div className="home--profile">
        <p>-- A software developer from a galaxy up north --</p>
        <hr />
        <p>
          Educated with a diploma in Front-End Web Development from{" "}
          <a
            href="https://openclassrooms.com/en/about-us"
            target="_blank"
            rel="noreferrer"
            aria-label="OpenClassrooms"
          >
            OpenClassrooms
          </a>
          .
        ...
        <div className="home--profile--socialMedia">
          <a
            href="https://www.linkedin.com/in/mb-developer/"
            target="_blank"
            rel="noreferrer"
            title="linkedIn"
            aria-label="linkedIn"
          ...
          <a
            href="mailto:mbucholski95@gmail.com"
            target="_blank"
            rel="noreferrer"
            title="email"
            aria-label="email"
